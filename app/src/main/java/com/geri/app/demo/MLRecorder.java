...
public class MLRecorder {
    ...
    private String filesFromSDCard = MeApplication.getContext().getExternalFilesDir("").getAbsolutePath() + "/";;
    ...
    public int startRecordVoice(String path) {
        ...
        if (path == null || path.equals("")) {
            ...
            recordFilePath = filesFromSDCard + System.currentTimeMillis() + ".amr";
        } else {
            recordFilePath = path;
        }
    ...
    public boolean deleteFile(String filepath) {
        Log.i("MLRecorder","删除文件：" + filepath);
